...
class BurpExtender(IBurpExtender, IHttpListener, ITab):
    def registerExtenderCallbacks(self, callbacks):
        ...
        self.defaultIgnoredHeaders = sorted([
            ...
            "Content-Security-Policy", "Content-Type", "Cookie", "Date", "Dnt", "ETag", "Expires", "Host", "If-Match",
            "If-Modified-Since", "If-None-Match", "If-Unmodified-Since", "Last-Modified", "Location", "Nel", "Origin",
            "Permissions-Policy", "Pragma", "Priority", "Range", "Referer", "Referrer", "Referrer-Policy", "Report-To",
            "request-context", "Sec-Fetch-Dest", "Sec-Fetch-Mode", "Sec-Fetch-Site", "Sec-Fetch-User", "Sec-CH-UA",
            "Sec-CH-UA-Mobile", "Sec-CH-UA-Platform", "Sec-GPC", "Server", "Server-Timeing", "Set-Cookie", "Speculation-Rules",
            "Strict-Transport-Security", "Te", "Transfer-Encoding", "Upgrade-Insecure-Requests", "User-Agent", "Vary", "Via",
            "X-AspNet-Version", "X-AspNetMvc-Version", "X-Amz-Cf-Id", "X-Amz-Cf-Pop", "x-amz-request-id", "x-amz-id-2", "X-Cache",
            "X-Cloud-Trace-Context", "X-Content-Type-Options", "X-DNS-Prefetch-Control", "X-Frame-Options", "X-Forwarded-Host",
