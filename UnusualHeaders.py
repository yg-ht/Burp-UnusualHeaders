...
class BurpExtender(IBurpExtender, IHttpListener, ITab):
    def registerExtenderCallbacks(self, callbacks):
        ...
        self.defaultIgnoredHeaders = sorted([
            ...
            "x-amz-id-2", "X-Cache", "X-Cloud-Trace-Context", "X-Content-Type-Options", "X-DNS-Prefetch-Control", "X-Frame-Options",
            "X-Forwarded-Host", "X-Goog-ACL", "X-Goog-Allowed-Resources", "X-Goog-API-Version", "X-Goog-Bucket-Object-Lock-Enabled",
